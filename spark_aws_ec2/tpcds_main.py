...
rc = [1000000, 1000000, 1000000, 1000000, 1000000]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--parquet_path",
        default="s3a://eventual-dev-benchmarking-fixtures/uncompressed/tpcds-dbgen/1000/"
    )
    args = parser.parse_args()
    print(f"Using Parquet files at: {args.parquet_path}")
    main(args.parquet_path, args.question)
